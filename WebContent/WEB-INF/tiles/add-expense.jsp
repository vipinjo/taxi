...
<div>
	...
	<form action="${action}" id="addShiftReportForm" method="post">
		...
		<div class="form-group row">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control" id="date" name="date" value="<fmt:formatDate value='${shiftReport.date}' pattern='yyyy/MM/dd HH:mm'/>">
			</div>
		</div>
			...
			<div class="col-sm-6">
				<select class="form-control" id="type" name="type" >
                    ...
                    <c:forEach var="tempExpenseType" items="${expenseTypeList}">
                        <option value="${tempExpenseType.id}" <c:if test = "${tempExpenseType.id == shiftReport.driver.id }">selected</c:if>>${tempExpenseType.name}</option>
                    </c:forEach>
                </select>
			</div>
		</div>
		...
		<div class="form-group row">
			<label for="meterRevenue" class="col-sm-2 col-form-label">Amount</label>
			<div class="col-sm-4">
		...
		<div class="form-group row">
			<label for="startMeterReading" class="col-sm-2 col-form-label">Meter Reading</label>
			<div class="col-sm-4">
                <input type="number" class="form-control" id="startMeterReading" name="meterReading"
